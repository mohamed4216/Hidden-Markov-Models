...
def run(_store):
	...
	data_column_names = ['RLAaccx', 'RLAaccy', 'RLAaccz' ,'RLAmagx', 'RLAmagy', 'RLAmagz', 'RLAgyrx', 'RLAgyry', 'RLAgyrz',  'RLAroll', 		'RLApitch', 'RLAyaw']  # Right hand accelerometer; check dataset.py for feature names
	p_TM = 0.7  # p(TM) - the entry probability of the garbage HMM; p(G) = (1 - p(TM)); See Lee & Kim paper
	...
	training_labels = [18,20,21]  # Can pick from [18, 19, 20, 21]; see above
	...
	test_participant = 11
	test_labels = [19]  # The labels associated with the gesture
...
#	# Add a noise state
	dummy = State(make_nd_distribution(data_dimension, NormalDistribution, [0, 30]), name='1337')
